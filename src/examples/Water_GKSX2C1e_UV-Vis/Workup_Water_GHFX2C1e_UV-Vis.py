...
result = parse_output('Water_GHFX2C1e_UV-Vis.pyo')
...
plt.legend()
plt.savefig('Water_GHFX2C1e_UV-Vis_Spectrum.png', bbox_inches='tight')

plt.figure()
plt.plot(result['time'], result['energy']*27.2114)
plt.ylabel('Energy (eV)')
plt.xlabel('Time (au)')
plt.savefig('Water_GHFX2C1e_UV-Vis_Energy.png', bbox_inches='tight')
