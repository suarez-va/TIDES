...
rt_cd = rt_scf.RT_SCF(cd, 0.25, 10000)
rt_cd.observables.update(charge=True, dipole=True)
...
delta_field = EfieldWithX2C(cd, [0.0001, 0.0000, 0.0000])
rt_cd.add_potential(delta_field)
